...
class _CommunityChallengesWidgetState extends State<CommunityChallengesWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CommunityChallenges'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('COMMUNITY_CHALLENGES_CommunityChallenges');
      logFirebaseEvent('CommunityChallenges_update_page_state');
      _model.streakPercentage = FFAppState().LoginStreak * 0.2;
      safeSetState(() {});
    });
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Complete challenges, earn tokens!',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyLarge
                                      .override(
                                        fontFamily: 'Inter',
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  LinearPercentIndicator(
                                    ...
                                    center: Text(
                                      valueOrDefault<String>(
                                        FFAppState().LoginStreak.toString(),
                                        '0',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                ...
                                children: [
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            'Use all app features in one day',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Inter',
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          color: FFAppState().leaderboardVisited
                                              ? FlutterFlowTheme.of(context)
                                                  .checkboxAccent
                                              : FlutterFlowTheme.of(context)
                                                  .uncheckedAccent,
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          color: FFAppState().blackjackVisited
                                              ? FlutterFlowTheme.of(context)
                                                  .checkboxAccent
                                              : FlutterFlowTheme.of(context)
                                                  .uncheckedAccent,
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          color: FFAppState().plinkoVisited
                                              ? FlutterFlowTheme.of(context)
                                                  .checkboxAccent
                                              : FlutterFlowTheme.of(context)
                                                  .uncheckedAccent,
                                      ...
                                      Container(
                                        decoration: BoxDecoration(
                                          color: FFAppState().minesweeperVisited
                                              ? FlutterFlowTheme.of(context)
                                                  .checkboxAccent
                                              : FlutterFlowTheme.of(context)
                                                  .uncheckedAccent,
