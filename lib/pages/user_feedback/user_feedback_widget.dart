...
class UserFeedbackWidget extends StatefulWidget {
  const UserFeedbackWidget({super.key});

  @override
  State<UserFeedbackWidget> createState() => _UserFeedbackWidgetState();
}

class _UserFeedbackWidgetState extends State<UserFeedbackWidget> {
  late UserFeedbackModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserFeedbackModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'UserFeedback'});
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              'How satisfied are you with the app\'s features?',
                                              style:
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'USER_FEEDBACK_SUBMIT_FEEDBACK_BTN_ON_TAP');
                                        logFirebaseEvent('Button_backend_call');

                                        await UserFeedbackRecord.createDoc(
                                                currentUserReference!)
                                            .set(createUserFeedbackRecordData(
                                          satisfaction: _model.sliderValue1,
                                          easeOfUse: _model.sliderValue2,
                                          netPromoterScore: _model.sliderValue3,
                                          comments: _model.textController.text,
                                        ));
                                        logFirebaseEvent(
                                            'Button_update_app_state');
                                        FFAppState().userFeedback = true;
