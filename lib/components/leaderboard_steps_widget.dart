...
import 'leaderboard_steps_model.dart';
export 'leaderboard_steps_model.dart';

class LeaderboardStepsWidget extends StatefulWidget {
  ...
  const LeaderboardStepsWidget({super.key});

  @override
  State<LeaderboardStepsWidget> createState() => _LeaderboardStepsWidgetState();
}

class _LeaderboardStepsWidgetState extends State<LeaderboardStepsWidget> {
  late LeaderboardStepsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaderboardStepsModel());
                  ...
                  StreamBuilder<List<UsersRecord>>(
                    stream: queryUsersRecord(
                      queryBuilder: (usersRecord) =>
                          usersRecord.orderBy('step_count', descending: true),
                      limit: 5,
                    ),
