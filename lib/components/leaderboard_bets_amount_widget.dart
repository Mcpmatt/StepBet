...
import 'leaderboard_bets_amount_model.dart';
export 'leaderboard_bets_amount_model.dart';

class LeaderboardBetsAmountWidget extends StatefulWidget {
  ...
  const LeaderboardBetsAmountWidget({super.key});

  @override
  State<LeaderboardBetsAmountWidget> createState() =>
      _LeaderboardBetsAmountWidgetState();
}

class _LeaderboardBetsAmountWidgetState
    extends State<LeaderboardBetsAmountWidget> {
  late LeaderboardBetsAmountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaderboardBetsAmountModel());
                  ...
                  StreamBuilder<List<UsersRecord>>(
                    stream: queryUsersRecord(
                      queryBuilder: (usersRecord) => usersRecord
                          .orderBy('total_bet_amount', descending: true),
                      limit: 5,
                    ),
                      ...
                      return Column(
                        ...
                        children: List.generate(columnUsersRecordList.length,
                          ...
                          final columnUsersRecord =
                              columnUsersRecordList[columnIndex];
                          return Text(
                            columnUsersRecord.totalBetAmount.toString(),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Inter',
