...
import 'leaderboard_vault_model.dart';
export 'leaderboard_vault_model.dart';

class LeaderboardVaultWidget extends StatefulWidget {
  ...
  const LeaderboardVaultWidget({super.key});

  @override
  State<LeaderboardVaultWidget> createState() => _LeaderboardVaultWidgetState();
}

class _LeaderboardVaultWidgetState extends State<LeaderboardVaultWidget> {
  late LeaderboardVaultModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaderboardVaultModel());
                  ...
                  StreamBuilder<List<UsersRecord>>(
                    stream: queryUsersRecord(
                      queryBuilder: (usersRecord) =>
                          usersRecord.orderBy('vault_value', descending: true),
                      limit: 5,
                    ),
                      ...
                      return Column(
                        ...
                        children: List.generate(columnUsersRecordList.length,
                          ...
                          final columnUsersRecord =
                              columnUsersRecordList[columnIndex];
                          return Text(
                            columnUsersRecord.vaultValue.toString(),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Inter',
